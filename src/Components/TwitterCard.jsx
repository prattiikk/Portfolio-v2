...
const TwitterCard = () => {
  return (
    <div className="row-start-3 col-span-1 cursor-pointer rounded-3xl bg-[#f4f2f2] transition duration-500 ease-in-out shadow-xl hover:bg-[#1DA1F2] aspect-w-1 aspect-h-1">
