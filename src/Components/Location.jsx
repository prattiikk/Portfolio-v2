  ...
  return (
    <div className="h-full w-full rounded-3xl relative group cursor-pointer overflow-hidden shadow-xl">
      ...
      >
        ...
        <AirplaneScene />
        <div className="absolute top-1/2 left-1/2 w-8 h-8 rounded-full bg-blue-400 border-4 border-white z-0 ">
          <div className=" w-full h-full rounded-full bg-blue-300 animate-ping duration-[2000ms]"></div>
        </div>
